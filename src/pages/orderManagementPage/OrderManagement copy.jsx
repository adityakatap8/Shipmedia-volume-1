...
function Main() {
    ...
    return (
        <div className="mx-auto border-2 rounded-3xl border-customGrey-300 p-10 order-managment-background">
            <div className='text-left text-2xl pb-4 mt-2 ml-10 text-white'>
            ...
            <form onSubmit={(e) => handleSubmit('on-demand')}>
                <div className=" p-2 mt-4 mb-4 flex">
                    {/* First Card */}
                    <div className="w-1/2 p-4 ml-5 mt-3 mb-3 flex flex-col justify-between text-white rounded-3xl w-64 h-[24rem] text-left order-button">
                        <div>
                    ...
                    {/* Second Card */}
                    <div className="w-1/2 p-4 ml-20 mt-3 mb-3 flex flex-col justify-between  text-white rounded-3xl w-64 h-[24rem] text-left order-button">
                        <div>
