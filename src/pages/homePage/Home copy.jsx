          ...
          <div className='row'>
            ...
            <div className='col-md-8 d-flex align-items-center'>
              ...
              <div className='align-items-center pl-4'>
                {/* <img className='img-fluid' src={HomeMainContent} alt="Home Main Content" /> */}
                <h1 className='text-5xl font-bold text-white text-left'>Service</h1>
                <p className='text-xl font-thin text-white h-8 w-40 pt-4 text-left'>Choose A Service</p>
              </div>
              <div className='align-items-center pl-4'>
                <img src={Arrow} className='h-8 w-24' alt="" />
              </div>
...
{/* Services accordion ends */}
      ...
      {/* Home page contact form section start */}
      <div className='section pt-48 pb-20'>
    <div className='container'>
        <div className='row' style={{ display: 'flex', alignItems: 'stretch' }}>
            <h2 className='mb-5' style={{ textAlign: 'center', fontSize: '40px', fontWeight: '700', color: '#3754B9', width: '100%' }}>Contact Us</h2>
            <div className='col-md-6 d-flex'>
                <div className="contact-right-section flex-grow-1 d-flex">
                    <form className="form-container" style={{ flex: 1 }}>
                        <div className="form-group pt-1">
                            <input type="text" className="form-textarea px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-500 focus:outline-none focus:ring focus:ring-blue-300" placeholder="Enter Name" />
                        </div>
                        <div className="form-group pt-1">
                        ...
                        <div className="form-group pt-1">
                            <input type="text" className="form-textarea px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-500 focus:outline-none focus:ring focus:ring-blue-300" placeholder="Enter Organization Name" />
                        </div>
                        <div className="form-group pt-1">
                            <input type="text" className="form-textarea px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-500 focus:outline-none focus:ring focus:ring-blue-300" placeholder="Enter Region" />
                        </div>
                        <div className="form-group pt-1">
                            <input type="tel" className="form-textarea px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-500 focus:outline-none focus:ring focus:ring-blue-300" placeholder="Enter Phone Number" />
                        </div>
            ...
            <div className='col-md-6 d-flex align-items-center contact-left-section' style={{ flex: 1 }}>
                <img className='contact-logo-image mx-auto' src={ShipmediaLogo2} alt="" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
        </div>
    </div>
</div>
