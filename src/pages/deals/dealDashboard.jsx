...
export default function DealDashboard() {
    ...
    const fetchSubDeals = async (dealId) => {
        try {
            setLoading(true)
            const response = await axios.get(`https://media-shippers-backend.vercel.app/api/deal/${dealId}/sub-deals`)
    ...
    const fetchDeals = async () => {
        try {
            ...
            const response = await axios.get(`https://media-shippers-backend.vercel.app/api/deal/deals-with-counts/${user._id}`)
    ...
    const getChatHistory = async (deal) => {
        try {
            const response = await axios.get(`https://media-shippers-backend.vercel.app/api/deal/${deal._id}/message-history`, {
                params: {
    ...
    const getUnreadMessageCount = async () => {
        try {
            const response = await axios.get(`https://media-shippers-backend.vercel.app/api/deal/unread-count/${dealId}/${user._id}`)
    ...
    const markMessagesAsRead = async (userId, dealId) => {
        try {
            await axios.post(`https://media-shippers-backend.vercel.app/api/deal/${dealId}/mark-read/${userId}`)
        } catch (error) {
    ...
    const handleSendDeal = async (dealId) => {
        try {
            setLoading(true) // Show loader
            const response = await axios.post("https://media-shippers-backend.vercel.app/api/deal/split-to-sellers", {
    ...
    const handleAccept = async (dealId) => {
        try {
            setLoading(true)
            const response = await axios.patch(`https://media-shippers-backend.vercel.app/api/deal/${dealId}/action`)
    ...
    const handleActionClick = async (status, movies) => {
        if (status === "accepted") {
            try {
                ...
                const response = await axios.patch(`https://media-shippers-backend.vercel.app/api/deal/${selectedDealId}/action`, {
