...
const CartPage = () => {
  ...
  const handleSubmitForm = async () => {
    try {
      ...
      // Call the API
      const response = await axios.put(`https://media-shippers-backend.vercel.app/api/deal/update/${selectedDeal._id}/cart/${user._id}`, payload);
  ...
  useEffect(() => {
    if (user?.role === 'Admin') {
      axios.get('https://media-shippers-backend.vercel.app/api/auth/all-users') // Replace with your actual endpoint
        .then((res) => {
