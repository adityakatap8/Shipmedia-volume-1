  ...
  return (
    ...
    <div>
          ...
          <div className='row services-row-one'>
            ...
            <div className='col-md-4 d-flex align-items-center justify-content-center'>
              ...
              <div className='text-center'>
                ...
                <div className="w-[85%] mx-auto mt-3 border-t-2 border-dotted border-[#3754B9]"></div>
            ...
            <div className='col-md-8 d-flex align-items-center justify-content-center'>
              ...
              <div className='text-center'>
                ...
                <div className="flex h-full border-2 rounded-3xl border-customGrey-300 p-8 mt-4 mb-4 m-4 overflow-hidden h-615">
                  <div className="w-2/3 pr-4 scrollable-content preset-section">
                    <h2 className="text-xl font-semibold mb-4">Presets</h2>
                    <div className="preset-grid">
                      {cards.map((card) => (
                        <button
                          key={card.id}
                          className={`preset-section-button p-2 border-2 rounded-3xl text-center ${selectedCard === card.id ? 'bg-customBlue-700 text-white' : 'border-gray-300 text-black'}`}
                  ...
                  <div className="w-1/2 bg-white shadow rounded-3xl h-600 overflow-y-auto scrollable-content codec-section">
                    <h2 className="text-xl font-semibold mb-2">{details.title}</h2>
                    <hr className='my-0 mx-[15px]' />
      ...
      <div className='section pt-16'>
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-md-4 d-flex align-items-center justify-content-center quality-check-mobile'>
              {/* Right Column Content */}
              <div className='text-center'>
                    ...
                    <div className="w-full overflow-y-auto mb-8">
                      ...
                      <div className="quality-check-grid">
                        {qualityCheck.map((qc) => (
                          <button
                            key={qc.id}
                            className={`quality-check-button p-2 border-2 rounded-3xl text-center ${selectedQc === qc.id
            ...
            <div className='col-md-4 d-flex align-items-center justify-content-center quality-check-laptop'>
              {/* Right Column Content */}
              <div className='text-center'>
                <h2 className='service-title'>Quality Check</h2>
                <div className="w-[60%] mx-auto mt-3 border-t-2 border-dotted border-[#3754B9]"></div>
                <p className='service-content'>Our quality check services ensure the integrity and excellence of your media. We perform thorough assessments across various categories, including container and compliance checks, as well as detailed video and audio evaluations. Our team meticulously analyzes technical specifications and synchronization to guarantee optimal performance and compliance. Trust us to enhance your production's reliability and deliver exceptional quality that captivates your audience.</p>
              </div>
            </div>
          </div>
          ...
          <div className='row'>
            ...
            <div className='col-md-4 d-flex align-items-center justify-content-center'>
              <div className='text-center'>
                ...
                <div className="w-[75%] mx-auto mt-3 border-t-2 border-dotted border-[#3754B9]"></div>
                <p className='service-content'>
                    ...
                    <div className="overflow-y-auto pr-4">
                      ...
                      <div className="portrait-grid">
                        {portrait.map((artwork) => (
                          <button
                            key={artwork.id}
                            className={`p-4 text-black border-2 rounded-3xl text-center ${selectedPortrait === artwork.id
                              ? 'bg-customBlue-700 border-customCardBlue-700 text-white'
                              : 'border-gray-300'
                              }`}
                    ...
                    <div className="overflow-y-auto pr-4">
                      ...
                      <div className="landscape-grid">
                        {landscape.map((artwork) => (
                          <button
                            key={artwork.id}
                            className={`p-4 text-black border-2 rounded-3xl text-center ${selectedLandscape === artwork.id
                              ? 'bg-customBlue-700 border-customCardBlue-700 text-white'
                              : 'border-gray-300'
                              }`}
      ...
      <div className='section pt-16'>
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-md-4 d-flex align-items-center justify-content-center file-transfer-mobile'>
              <div className='text-center'>
                <h2 className='service-title'>File Transfer and Packaging</h2>
                <div className="w-[100%] mx-auto mt-3 border-t-2 border-dotted border-[#3754B9]"></div>
            ...
            <div className='col-md-8 d-flex align-items-center justify-content-center'>
              ...
              <div>
                <div className="flex border-2 rounded-3xl border-customGrey-300 p-6 mt-4 mb-8 m-4">
                  ...
                  <div className="overflow-y-auto pr-4">
                    ...
                    <div className="file-transfer-grid">
                      {fileTransfer.map((ft) => (
                        <button
                          key={ft.id}
                          className={`p-4 text-black border-2 rounded-3xl text-center ${selectedFileTransfer === ft.id
                            ? 'bg-customBlue-700 border-customCardBlue-700 text-white'
                            : 'border-gray-300'
            ...
            {/* Right Column Content */}
            <div className='col-md-4 d-flex align-items-center justify-content-center file-transfer-laptop'>
              <div className='text-center'>
                <h2 className='service-title'>File Transfer and Packaging</h2>
                <div className="w-[60%] mx-auto mt-3 border-t-2 border-dotted border-[#3754B9]"></div>
                <p className='service-content max-w-full px-4'>
                  Our file transfer and packaging services ensure secure and efficient delivery of your media assets. Using advanced technology, we provide fast and reliable transfers while maintaining top security standards. Our team expertly packages your files for optimal compatibility, ensuring they are ready for any platform. With meticulous attention to detail, we guarantee safe delivery and professional presentation, giving you peace of mind throughout the process.
                </p>
              </div>
            </div>
