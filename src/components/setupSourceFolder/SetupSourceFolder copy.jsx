...
const SetupSourceFolder = () => {
    ...
    //             },
    //             body: JSON.stringify(sourceTypeData)
    //         });
    ...
    const handleSave = async () => {
        try {
            ...
            const metadataData = metadata && Object.keys(metadata).length > 0 ? metadata : null;  // Send as is if present
            ...
            >
              {hasFileSelected ? 'Cancel' : 'Select'}
                    ...
                    <div className="flex justify-end w-full">
                        <button className="py-2 px-5 bg-customCardBlue text-white rounded-3xl mr-4">
                            Next
                        </button>
                    </div>
