...
const PlanCards = () => {
    return (
        <div className="flex flex-col items-left border-2 rounded-3xl border-customGrey-300 p-8 mt-4 mb-4 ">
            ...
            <div className='mt-2 ml-8 text-left'>
                ...
                <div className="bg-white p-3 rounded-3xl border-2 border-customCardBlue">
                    <p className='ml-28'>Purchase a plan to reactivate your services.
