                ...
                <div>
                    ...
                    >
                        ...
                        <div className="w-2/3 overflow-y-auto pr-4">
                            ...
                            {/* Updated code block with selectedOptions.codec */}
                            <div className="grid grid-cols-3 gap-4">
                                {cards.map((card) => (
                                    <button
                                        key={card.id}
                                        className={`p-4 text-black border-2 border-gray-300 rounded-3xl text-center ${selectedOptions.codec === card.id ? 'bg-customBlue-700 border-customCardBlue-700 text-white' : 'border-gray-300'
                                            }`}
                                        onClick={() => isCheckboxChecked && setSelectedOptions((prev) => ({ ...prev, codec: card.id }))}
